...
ET_SRC = $(addprefix $(EXECUTION_DIR), backup_env.c child_proccess_mangement.c command_handler.c exec_cmd.c get_env.c get_exec_path.c get_path.c her_doc.c her_doc_management.c multiple_command.c \
	ridirections.c run_sing_command.c signals.c)

ED_SRC = $(addprefix $(EXPANDING_DIR), expand_commands.c expand_env_variables.c here_doc_expanding.c)
UT_SRC = $(addprefix $(UTILS_DIR), clean_fd.c env_list_utils.c env_to_array.c errors.c find_key.c ft_atoi.c ft_is_digit.c ft_lstlast.c ft_putstr_fd_bonus.c ft_spli.c \
	ft_strcmp.c ft_strlcat.c garbag_collector.c her_doc_utils.c libft_utils0.c libft_utils1.c libft_utils2.c libft_utils3.c list_data.c list_size.c list_utils.c normal_split.c split_qoutes.c update_status.c)
